...
public class isMinorPartOfGroupTest {
	...
	/*public void test() {
		...
		String singleCountry4 = "Weimarer Republic";
		String[] splitCountries4 = {"Nazi Germany","Italy","Germany", "Weimarer Republic"};
		assertEquals(q.isMinorPartOfGroupCountries(singleCountry4, splitCountries4),true);		

		String singleCountry5 = "Weimarer Republic";
		String[] splitCountries5 = {"Italy", "Weimarer Republic","Nazi Germany"};
		assertEquals(q.isMinorPartOfGroupCountries(singleCountry5, splitCountries5),false);
		
		String singleCountry6 = "Nazi Germany";
		String[] splitCountries6 = {"Italy", "Weimarer Republic","Nazi Germany"};

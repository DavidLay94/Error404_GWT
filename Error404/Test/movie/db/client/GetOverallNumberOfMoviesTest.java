...
public class GetOverallNumberOfMoviesTest extends GWTTestCase {
	...
	public void test() {
		...
		assertEquals(PieChartWebPage.getOverallNumberOfMovies(list1), NUMBER_OF_MOVIES1+NUMBER_OF_MOVIES2+NUMBER_OF_MOVIES3+NUMBER_OF_MOVIES4+NUMBER_OF_MOVIES5);
		assertEquals(PieChartWebPage.getOverallNumberOfMovies(list2), NUMBER_OF_MOVIES5);
		assertEquals(PieChartWebPage.getOverallNumberOfMovies(list3), 0);
